...
public class PetRockFeatureRenderer extends LayerRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
    ...
    private static final String player_uuid = Minecraft.getInstance().getSession().getPlayerID().replace("-","").toString();
    private static final List<AbstractClientPlayerEntity> player_uuid2 = Minecraft.getInstance().world.getPlayers();
